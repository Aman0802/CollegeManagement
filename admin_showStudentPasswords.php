...
<head>
  ...
  <title>Show Student Passwords</title>
  ...
  <div id="main">
    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold active"><a href="#">SHOW STUDENT PASSWORDS</a></li>
        </ul>
          ...
          <div class="container-2">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">STUDENT PASSWORDS</h5>
              </div>
            </div>
          </div>
        </div>
        <!--breadcrumbs end-->
	<h1 align='center'>Student Password Portal</h1>
	<marquee>Here is the list of the present passwords of all the students! Click on the *Change Password* button to change the password of any specific sudent</marquee>
	...
	<?php
		...
		while($row=mysqli_fetch_array($rs))
		{
			...
			echo "<td><input type='text' name='txtPassword' value='".$row['password']."'></td>";
			echo "</tr>";
		}
	?>
    </form>
