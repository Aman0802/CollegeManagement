...
<body>
  ...
  <div id="main">
    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold active"><a href="#">ANSWER QUESTIONS</a></li>
          ...
          <div class="container-2">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">UNANSWERED QUESTIONS</h5>
              </div>
            </div>
          </div>
        </div>
    ...
    <?php
        ...
        $q1="select * from question where answer ='Not Answered'";
        ...
        while($row=mysqli_fetch_array($rs))
        {
            ...
            echo "<td>";
            echo '<a href="admin_answer.php?sno='.$row[0].'">';
