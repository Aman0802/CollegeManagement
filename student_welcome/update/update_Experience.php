<html>
                    ...
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold" class="bold active"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-editor-insert-invitation"></i> UPDATE PROFILE</a>
                            <div class="collapsible-body">
                                ...
                                <li><a href="update_Qualification.php"> QUALIFICATION</a></li>
                                <li class="bold active"><a href="#">EXPERIENCE</a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
 ...
 <section id="content">
        ...
        <form action="" method="POST">
            ...
            $qry="SELECT experience from admin_detail where id='$id'"; //Seesion id
            $rs=mysqli_query($con,$qry);
            while($row=mysqli_fetch_array($rs))
                echo "<input type='text' name='txtOldExp' value='".$row['experience']."'";
            ?>
            <input type="text" name="txtNewExp" placeholder="Enter New Experience" ><br>
            <input type="text" name="txtNewExp" placeholder="Confirm Experience" data-validate><br>
            ...
            {
                $con=mysqli_connect('localhost','root','','php_project');
                $qry="UPDATE * from admin_detail SET experience='".$_POST['txtNewExp']."'where id='$id'"; //Seesion id
                $rs=mysqli_query($con,$qry);
            ...
            {
                header("location:../student_welocme.php");
            }
            ?>
       </form>
          </section>
