...
<head>
    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li ><a href="../student_welcome.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i>HOME</a>
            </li>
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-editor-insert-invitation"></i> UPDATE PROFILE</a>
                            <div class="collapsible-body">
                                <ul>
                                <li class="bold active"><a href="#">UPDATE PASSWORD</a></li>
                                <li><a href="update_email.php"> E-MAIL</a></li>
                                <li><a href="update_Mobile.php"> MOBILE NUMBER</a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
 ...
 <section id="content">
        ...
        <form action="" method="POST">
           ...
           // $qry="SELECT password from admin_login where id='$id'"; //Seesion id
           // $rs=mysqli_query($con,$qry);
           // while($row=mysqli_fetch_array($rs))
            //    echo "<input type='text' name='txtOldPass' value='".$row['password']."' placeholder='Enter Old Password'";
            ?>-->
            <input type="text" name="txtOldPass" placeholder="Enter Old Password" ><br>
            <input type="text" name="txtNewPass" placeholder="Enter New Password" ><br>
            <input type="text" name="txtConPass" placeholder="Confirm Password" data-validate><br>
            ...
            if(isset($_POST['btnupdate']))
            {
            	...
            	{
                	$con=mysqli_connect('localhost','root','','php_project');
                	$qry = "update student_detail SET password='".$_POST['txtNewPass']."' where id = ".$_SESSION['userid'];
            	...
            	{
            		echo "Passwords do not match";// proper alert box here
            	}
            }
