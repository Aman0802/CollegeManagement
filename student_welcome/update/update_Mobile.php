...
<html>
        ...
        <div class="navbar-fixed">
            <nav class="top-nav-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li><h1 class="logo-wrapper"><a href="../student_welcome.php" class="brand-logo darken-1"><img src="../../logouniversity.png" alt="logo"></a> <span class="logo-text">Logo</span></h1></li>
                    </ul>
    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li c><a href="../student_welcome.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i>HOME</a>
            </li>
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-editor-insert-invitation"></i> UPDATE PROFILE</a>
                            <div class="collapsible-body">
                                ...
                                <li class="bold active"><a href="update_Mobile.php"> MOBILE NUMBER</a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
 ...
 <section id="content">
        ...
        <form action="update_mobile_temp.php" method="POST">
            <?php
            $con=mysqli_connect('localhost','root','','php_project');
            $qry="select mobile_no from student_detail where id='".$_SESSION['userid']."'"; //Seesion id
            $rs=mysqli_query($con,$qry);
            $row=mysqli_fetch_array($rs);
                echo "<input type='text' name='txtOldEmail' value='".$row['mobile_no']."'>";
            ?>
            <input type="text" name="txtNewMobile" placeholder="Enter New Mobile" ><br>
