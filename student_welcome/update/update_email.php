...
<html>
                    ...
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-editor-insert-invitation"></i> UPDATE PROFILE</a>
                            <div class="collapsible-body">
                                ...
                                <li class="bold active"><a href="update_email.php"> E-MAIL</a></li>
 ...
 <section id="content">
        ...
        <form action="" method="POST">
            ...
            $qry="select email from student_detail where id=".$_SESSION['userid']; //Seesion id
            $rs=mysqli_query($con,$qry);
            $row=mysqli_fetch_array($rs);
                echo "<input type='text' name='txtOldEmail' value='".$row['email']."'>";
            ?>
            <input type="text" name="txtNewEmail" placeholder="Enter New E-mail" ><br>
            <input type="text" name="txtNewEmail" placeholder="Confirm E-mail" data-validate><br>
            ...
            {
                $con=mysqli_connect('localhost','root','','php_project');
                $qry="update student_detail set email='".$_POST['txtNewEmail']."' where id=".$_SESSION['userid']; //Seesion id
                $rs=mysqli_query($con,$qry);
