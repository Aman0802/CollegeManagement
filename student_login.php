	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="" method="post">
					...
					<div class="text-center p-t-136">
						<a class="txt2" href="../all/student_registration.php">
							Register Now!
            ...
            if(isset($_POST['submit']))
            {
                ...
                $con_save=mysqli_connect('localhost','root','','php_project');
                $qry_save="select name from student_detail where id='".$Id."'";
                $rs_save=mysqli_query($con_save,$qry_save);
                $row=mysqli_fetch_array($rs_save);
