        ...
        <div class="navbar-fixed">
            <nav class="top-nav-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li><h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1"><img src="logouniversity.png" alt="logo" width="60px"></a> <span class="logo-text">Logo</span></h1></li>
                    </ul>
                ...
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-action-question-answer"></i> SEE NEW</a>
                            <div class="collapsible-body">
                                <ul>
                                <li class="bold-active"><a href="#">NOTICES</a></li>
          ...
          <div class="container-2">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">CHECK NOTICES</h5>
              </div>
            </div>
          </div>
        </div>
...
<body>
	...
	<table border="1" class="table">
      ...
      $qry1="select * from notice_id where id_of_receiver = ".$_SESSION['userid'];
      ...
      $qry2="select * from notice_class,student_detail where class_of_receiver = class and id = ".$_SESSION['userid'];
      ...
      $qry3="select * from notice_semester, student_detail where student_detail.semester = notice_semester.semester and id = ".$_SESSION['userid'];
