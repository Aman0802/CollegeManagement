        ...
        <div class="navbar-fixed">
            <nav class="top-nav-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li><h1 class="logo-wrapper"><a href="student_welcome/student_welcome.php" class="brand-logo darken-1"><img src="logouniversity.png" alt="logo"></a> <span class="logo-text">Logo</span></h1></li>
                    </ul>
  ...
  <div id="main">
    ...
    <div class="wrapper">
                ...
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-action-question-answer"></i> SEE NEW </a>
                            <div class="collapsible-body">
                                <ul>
								<li><a href="student_welcome/student_seeNewNotices.php">NOTICES</a> </li>
                                    <li><a href="student_welcome/student_seeResult.php">RESULT</a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
                    <li class="bold active"><a href="#" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i>FAQS</a></li>
                </li>									
        </ul>
      ...
      <section id="content">
        ...
        <!--breadcrumbs end-->
    <link rel="stylesheet" type="text/css" href="css/faqscsss.css">
